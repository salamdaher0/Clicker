...
<button id= "btn_16" class= "button_simple" onclick="oneClick_Function(event, 16)">G3_sink</button>

<div id="common_group">
<button id= "btn_mistake" class= "button_mistake" onclick="mistake_Function()">.</button>

<button id= "btn_email" class= "button_email" onclick="email_Function('G3')">.</button>
</div>
